...
bool canCastle(char grid[8][8], int row, int col, int toRow, int toCol, char turn, int mainTurn)
{
    ...
    if(turn=='W')
    {
        ...
        if(toCol==2)
        {
            ...
            flag = !hasMoved[7][0]&&isEmpty(grid,7,1)&&isEmpty(grid,7,2)&&isEmpty(grid,7,3)&&!hasMoved[7][4]&&isValid(grid,trial,turn,1);
            if(flag&&mainTurn==2)
                move(grid,7,0,7,3,0);
        }
        else
        {
            ...
            flag = !hasMoved[7][4]&&isEmpty(grid,7,5)&&isEmpty(grid,7,6)&&!hasMoved[7][7]&&isValid(grid,trial,turn,1);
            if(flag&&mainTurn==2)
                move(grid,7,7,7,5,0);
        }
    }
    else
    {
        ...
        if(toCol==2)
        {
            ...
            flag = !hasMoved[0][0]&&isEmpty(grid,0,1)&&isEmpty(grid,0,2)&&isEmpty(grid,0,3)&&!hasMoved[0][4]&&isValid(grid,trial,turn,1);
            if(flag&&mainTurn==2)
                move(grid,0,0,0,3,0);
        }
        else
        {
            ...
            flag = !hasMoved[0][4]&&isEmpty(grid,0,5)&&isEmpty(grid,0,6)&&!hasMoved[0][7]&&isValid(grid,trial,turn,1);;
            if(flag&&mainTurn==2)
                move(grid,0,7,0,5,0);
        }
    }
