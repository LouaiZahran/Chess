...
void GUI()
{
    ...
    window=SDL_CreateWindow("Trial", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL);
    ...
    while(gameRunning&&renderedEnd<2)
    {
        ...
        while(SDL_PollEvent(&event))
        {
            ...
            case SDL_MOUSEBUTTONDOWN:
                ...
                int row=-1,col=-1;
                if(mousePosX>OFFSET_X&&mousePosX<OFFSET_X+BOARD_WIDTH&& mousePosY>OFFSET_Y && mousePosY<OFFSET_Y+BOARD_HEIGHT){
